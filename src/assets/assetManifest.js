  ...
  TH.AssetManifest = {
    ...
    beatmap: {
      ...
      manualData: {
        ...
        note: '214 tuiles et 11 tapis glissants tapés à l\'oreille par Ylonna, fusionnés depuis deux prises (export mis à jour ; versions précédentes : 210/17, 155/49, puis 214/1). Remplace la détection automatique pour ce morceau ; un futur morceau sans beatmap manuel retombe automatiquement sur audio/beatDetector.js (voir main.js).',
      },
    },
